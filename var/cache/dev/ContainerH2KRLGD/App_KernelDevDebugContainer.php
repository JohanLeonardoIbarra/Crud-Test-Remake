...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('Symfony\\Component\\Messenger\\Event\\WorkerMessageHandledEvent', [0 => #[\Closure(name: 'doctrine_mongodb.messenger.event_subscriber.doctrine_clear_document_manager', class: 'Symfony\\Bridge\\Doctrine\\Messenger\\DoctrineClearEntityManagerWorkerSubscriber')] function () {
        ...
        $instance->addListener('Symfony\\Component\\Messenger\\Event\\WorkerMessageFailedEvent', [0 => #[\Closure(name: 'doctrine_mongodb.messenger.event_subscriber.doctrine_clear_document_manager', class: 'Symfony\\Bridge\\Doctrine\\Messenger\\DoctrineClearEntityManagerWorkerSubscriber')] function () {
            return ($this->privates['doctrine_mongodb.messenger.event_subscriber.doctrine_clear_document_manager'] ?? $this->load('getDoctrineMongodb_Messenger_EventSubscriber_DoctrineClearDocumentManagerService'));
        }, 1 => 'onWorkerMessageFailed'], 0);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DaSegQqWBA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
